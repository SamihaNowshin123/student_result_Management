...
#         self.photo = self.photo.subsample(5)
#
#         # Title
...
#         if self.role != 'Student':  # Only show these buttons if role is not Student
...
#         btn_student.place(x=460 if self.role != 'Student' else 20, y=5, width=200, height=40)  # Adjust placement based on role
#
...
#         self.image = self.image.subsample(2)  # Resize image to fit
