...
#  #title........
#         title=Label(self.root,text="COURSE MANAGEMENT",font=("goudy old style",20,"bold"),bg="Darkblue",fg="White").place(x=10,y=15,width=1180,height=40)
# #Variables......
...
#
#         self.CourseTable=ttk.Treeview(self.C_Frame,columns=("Cid","Name","Duration","Charge","Description"),xscrollcommand=scrollx.set,yscrollcommand=scrolly.set)
...
#              row=cur.fetchone()
#              if row!=None:
#               messagebox.showerror("Error","Corse Name Already Present",parent=self.root)
#              else:
...
#                  ) )
#                  con.commit()
#                  messagebox.showinfo("Success","Course Added Successsfully",parent=self.root)
#                  self.show()
#         except Exception as ex:
#            messagebox.showerror("Error",f"Error due to {str(ex)}")
#
